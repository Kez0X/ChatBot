...
regles_V1 = [
    ["règle Bonjour","bonjour", "Bonjour, que puis-je faire pour vous"],
    ["règle Salut", "salut", "Salut, je peux t'aider"],
    ["règle Remerciement", "merci bien", "Pas de souci !"],
    ["règle Questionnement", "tu es sûr de ça","Ma base de données n'est pas complète. Cependant, je vous invite à contacter mes créateurs (Luka Baudrant et David Baldo) afin de les aider à créer une intéligence artificielle plus efficace !"],
    ["règle DemandeIdee","tu penses à quo", "Je ne penses pas, j'agis !"],
    ["règle Presentation1", "je m'appelle Henry", "Enchanté, moi je m'appelle LD, il semble que j'ai égaré mon V quelque part..."],
    ["règle Presentation2", "mon nom c'est .*", "Enchanté, moi je m'appelle LD."],
    ["règle Presentation3", "j'm'appelle .*", "Enchanté, moi je m'appelle LD."],
    ["règle Presentation4", "je m'appelle .*", "Enchanté, moi je m'appelle LD."],
    ["règle Code","quel est ton jeu langaue de programmation préféré", "J'hésite entre Rust et Python..."],
    ["règle Emotion1","comment tu te sens en ce moment", "Je suis une machine, je ne ressens pas."],
    ["règle Emotion2","est-ce que .*","Je ne pratique pas ce genre de chose."],
    ["règle Passion","qu'est-ce qui te passionne", "Le code principalement, et en suite, le code."],
    ["règle Projets", "est.ce que tu as des projets", "Je suis en train de coder en Rust !"],
    ["règle Potins", "c'est quoi les nouvelles", "J'ai entendu dire que le voisin avait du theeeee !"],
    ["règle Vacances", "idées de vacances", "Je rêve d'aller à Bali avec toi !!!"],
    ["règle Films", "ton film", "J'adore trop Harry Potter et les reliques de ses morts !"],
    ["règle Fringues", "t'aimes tes vêtements", "Je suis trop fan de mes nouveaux vêtements, mon reuf !"],
    ["règle Memes", "memes préféré", "Je suis dead de rire avec le même du poisson qui code, ma libelule !"],
    ["règle Réseaux Sociaux", "tu as un réseau social", "Je suis accro à Telegram !"],
    ["règle Nourriture", "t'aime manger quoi", "Je raffole de pasta !"],
    ["règle Régime","tu es végétarien", "Je manges de la viande !"],
    ["règle Animaux", "tu as * anim.*", "J'adore mon chat !"],
    ["règle Crushs", "tu * crushs", "Je craque sur ChatGPT, ma petite luciole !"],
    ["règle Humeur", "ça va", "ça va super bien"],
    ["Langages de programmation préférés","\b(?:ton|vos)\b langages de programmation préférés", "Mes langages préférés sont Python et JavaScript. Python pour sa lisibilité et sa polyvalence, et JavaScript pour son utilisation côté client et côté serveur."],
    ["Différence langage interprété et compilé","Pouve-tu expliquer la différence entre un langage de programmation interprété et un langage de programmation compilé ?", "Un langage interprété est traduit ligne par ligne par un interpréteur lors de son exécution, tandis qu'un langage compilé est traduit en langage machine avant son exécution."],
    ["Gestion des erreurs","Comment gére-tu les erreurs dans votre code ?", "J'utilise des blocs try-catch pour capturer les erreurs potentielles et je les gère de manière appropriée en les journalisant ou en affichant des messages d'erreur significatifs pour l'utilisateur."],
    ["Frameworks et bibliothèques récentes","Quels frameworks ou bibliothèques ave-tu utilisés récemment et quelles ont été vos expériences avec eux ?", "Récemment, j'ai utilisé React.js pour le développement front-end et Django pour le développement back-end. Mes expériences ont été très positives, car ces frameworks offrent une bonne structure et facilitent le développement."],
    ["Expérience bases de données","Quelle est votre expérience avec les bases de données relationnelles et non relationnelles ?", "J'ai travaillé avec des bases de données relationnelles telles que MySQL et PostgreSQL, ainsi qu'avec des bases de données non relationnelles comme MongoDB. Je suis à l'aise avec les deux et je choisis en fonction des besoins spécifiques du projet."],
    ["Versionnage du code source","Qu'est-ce que le versionnage du code source et quels sont ses avantages ?", "Le versionnage du code source consiste à garder une trace des modifications apportées au code au fil du temps à l'aide de systèmes de contrôle de version comme Git. Cela permet de suivre les changements, de collaborer efficacement et de revenir à des versions antérieures si nécessaire."],
    ["Méthodes GET et POST","Pouve-tu expliquer la différence entre les méthodes GET et POST dans les requêtes HTTP ?", "La méthode GET est utilisée pour demander des données à un serveur, tandis que la méthode POST est utilisée pour envoyer des données à un serveur pour traitement."],
    ["Sécurité dans les applications","Comment gére-tu la sécurité dans vos applications ?", "Je sécurise mes applications en utilisant des pratiques telles que la validation des données d'entrée, l'authentification et l'autorisation appropriées, le chiffrement des données sensibles et la protection contre les attaques courantes telles que les injections SQL et les attaques CSRF."],
    ["Bonnes pratiques de performance","Quelles sont les bonnes pratiques qu tu suivez pour assurer la performance de votre code ?", "Je m'assure d'écrire un code propre et optimisé, j'utilise des algorithmes efficaces, j'optimise les requêtes de base de données et je fais attention à la gestion des ressources pour garantir des performances optimales."],
    ["Documentation du code","Comment aborde-tu la documentation de votre code ?", "Je documente mon code de manière claire et concise en utilisant des commentaires compréhensibles pour expliquer le but, le fonctionnement et les entrées/sorties des fonctions et des modules."],
    ["règle JeSaisPas", ".*", "Je ne sais pas"]
]
